...
namespace ThreeOneThree.Proxima.Agent
{
  ...
  int nFileSystemNameSize);
        ...
        */
        ...
        public static string GetVolumeType(string VolumePath)
        {
            StringBuilder volname = new StringBuilder(261);
            StringBuilder fsname = new StringBuilder(261);
            uint sernum, maxlen;
            FileSystemFeature flags;
            if (!GetVolumeInformation(VolumePath, volname, volname.Capacity, out sernum, out maxlen, out flags, fsname, fsname.Capacity))
